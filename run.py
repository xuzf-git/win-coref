...
if __name__ == "__main__":
    ...
    argparser.add_argument("--data-split",
    ...
    argparser.add_argument("--warm-start",
                           action="store_true",
    ...
    argparser.add_argument("--word-level",
                           action="store_true",
    ...
    if args.mode == "train":
        if args.weights is not None or args.warm_start:
            model.load_weights(path=args.weights, map_location="cpu", noexception=args.warm_start)
